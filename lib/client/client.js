...
module.exports = class DiscoveryClient {
    constructor(platform, db, thingpedia) {
        // in loading order
        this._modules = [new GlobalDeviceManager(platform, db),
                         new AllJoynDiscovery(platform, db, thingpedia),
                         new BluetoothDiscovery(platform, db, thingpedia)];
    }
